...
<header>
    ...
    <section class="logoback">
        <div class="logoback-content">
    ...
    <section id="movies" class="movie-listing">
        ...
        <div class="movie-grid">
            <div class="movie-card">
                <img src="images/image6.jpg" alt="Movie 1 Poster">
                <div class="movie-card-content">
                    <h3> Dark 2023 </h3>
                    <p>Genre: Drama , Horror</p>
                    <a href="./Movie/dark.php" class="cta-button">Details</a>
                    <a href="./Booking/Booking.html" class="cta-button">Book Now</a>
                </div>
            </div>
            <div class="movie-card">
                <img src="images/image20.jpg" alt="Movie 2 Poster">
                <div class="movie-card-content">
                    <h3> Me Before You </h3>
                    <p>Genre: Action, Comedy, Romance </p>
                    <a href="./Movie/MeBeforeYou.php" class="cta-button">Details</a>
                    <a href="./Booking/Booking.html" class="cta-button">Book Now</a>                </div>
            </div>
            <div class="movie-card">
                <img src="images/image8.jpg" alt="Movie 3 Poster">
                <div class="movie-card-content">
                    <h3> Devara </h3>
                    <p>Genre: Action, Drama</p>
                    <a href="./movie/Devara.php" class="cta-button">Details</a>
                    <a href="./Booking/Booking.html" class="cta-button">Book Now</a>
                </div>
                </div>
                <div class="movie-card">
                <img src="images/image16.jpg" alt="Movie 4 Poster">
                <div class="movie-card-content">
                    <h3> Freedy</h3>
                    <p>Genre: Horror, Mystery, Triller  </p>
                    <a href="./movie/Freedy.php" class="cta-button">Details</a>
                    <a href="./Booking/Booking.html" class="cta-button">Book Now</a>                </div>
            </div>
    ...
    <section id="movies" class="movie-listing1">
        ...
        <div class="movie-grid">
            <div class="movie-card">
                <img src="images/image12.jpg" alt="Movie 1 Poster">
                <div class="movie-card-content">
                    <h3> Fool Me Once 2024 </h3>
                    <p>Genre: Action , Comedy, Crime </p>
                    <a href="./Movie/FoolMeOnce.php" class="cta-button">Details</a>
                    <a href="./Booking/Booking.html" class="cta-button">Book Now</a>
                </div>
            </div>
            <div class="movie-card">
                <img src="images/image15.jpg" alt="Movie 2 Poster">
                <div class="movie-card-content">
                    <h3> Avatar 2024 </h3>
                    <p>Genre: Action, Drama, Romance </p>
                    <a href="./Movie/Avatar.php" class="cta-button">Details</a>
                    <a href="./Booking/Booking.html" class="cta-button">Book Now</a>                
                    </div>
            </div>
            <div class="movie-card">
                <img src="images/image17.jpg" alt="Movie 3 Poster">
                <div class="movie-card-content">
                    <h3> Gravity 2024 </h3>
                    <p>Genre: Action, Triller</p>
                    <a href="./Movie/Gravity.php" class="cta-button">Details</a>
                    <a href="./Booking/Booking.html" class="cta-button">Book Now</a>
                </div>
                </div>
                <div class="movie-card">
                <img src="images/image21.jpg" alt="Movie 4 Poster">
                <div class="movie-card-content">
                    <h3> Extraction 2024 </h3>
                    <p>Genre: Action, Drama  </p>
                    <a href="./Movie/Extraction.php" class="cta-button">Details</a>
                    <a href="./Booking/Booking.html" class="cta-button">Book Now</a>                
                    </div>
            </div>
            <div class="movie-card">
                <img src="images/image11.jpg" alt="Movie 4 Poster">
                <div class="movie-card-content">
                    <h3> Christmas Angel 2024 </h3>
                    <p>Genre: Horror, Triller  </p>
                    <a href="./Movie/ChristmasAngel.php" class="cta-button">Details</a>
                    <a href="./Booking/Booking.html" class="cta-button">Book Now</a>                
                    </div>
            </div> 
    </section>
...
<section class="best-movie-section">
        ...
        <div class="best-movie-container">
            <div class="best-movie-card">
                <img src="./images/image22.jpg" alt="Thank-God 2023 Poster">
                <div class="best-movie-card-content">
                    <h3><Thank-God></Thank-God></h3>
                    <p>Genre: Action, Crime, Drama</p>
                    <p>Runtime: 2h 15m</p>
                    <p>Director: Indra Kumar</p>
                    <div class="stars">
                        <span class="star">&#9733;</span>
                        <span class="star">&#9733;</span>
                        <span class="star">&#9733;</span>
...
<section id="trending-events">
        ...
        <div class="event-container">
            <div class="event-card">
                <img src="./img/battle.jpg" alt="Movie 1 Poster">
            ...
            <div class="event-card">
                <img src="./img/Dance.jpg" alt="Movie 2 Poster">
                <div class="event-card-content">
                    <h3>Dance Party:</h3>
            ...
            <div class="event-card">
                <img src="img/couple.jpg" alt="Movie 3 Poster" width="50" height="50">
                <div class="event-card-content">
                    <h3> Couple Package:</h3>
                    <p>Choose your favorite films or enjoy a curated selection of romantic classics.</p>
                    <a href="#">More Info</a>
                </div>
            </div>
        </div>
        ...
        <section class="footer">
            ...
            <div class="box-container">
                <div class="box">
                    ...
                    <a href="Contactus.html"><i></i> Ask Question</a>
                ...
                <div class="box">
                    <br>
                    <h3>Contact Info</h3>
                    <a href="#"> <i></i> +94766997850</a>
                    <a href="#"> <i></i> cineplexmovies@gmail.com</a>
                    <a href="#"> <i></i> Kandy, Sri Lanka</a>
